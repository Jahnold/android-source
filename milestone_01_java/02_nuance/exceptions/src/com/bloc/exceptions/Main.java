...
public class Main extends Object {
	...
	private static final void tryGetMax() {
		...
		try {
			...
			System.out.println("getMax IllegalArgument");
		}
		catch (IllegalStateException e) {
			System.out.println("getMax IllegalStateException");
		}
	}
	...
	private static final void tryRemove() {
		try {
			...
			System.out.println("remove IllegalArgument");
		}
		catch (IndexOutOfBoundsException e) {
			System.out.println("remove IndexOutOfBoundsException");
		}
	}
}
